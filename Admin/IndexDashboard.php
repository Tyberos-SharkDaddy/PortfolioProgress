    ...
    <script>
        ...
        document.getElementById('dataFilter').addEventListener('change', e => {
            ...
            ['services', 'services2', 'payments', 'profit', 'bookings', 'projects'].forEach(key => {
                document.getElementById(`${key}Card`).style.display = (sel === 'all' || sel === key) ? 'block' : 'none';
            });
        ...
        function updateLineChart(type, event) {
            ...
            analyticsLineChart.data.datasets[0].label = label;
            analyticsLineChart.data.datasets[0].data = data;
            analyticsLineChart.data.datasets[0].borderColor = borderColor;
            analyticsLineChart.data.datasets[0].backgroundColor = backgroundColor;
            analyticsLineChart.update();
        }
